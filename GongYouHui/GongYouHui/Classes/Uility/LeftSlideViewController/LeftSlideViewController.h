...
#define kMainPageCenter  CGPointMake(GYHScreenWidth + GYHScreenWidth * kMainPageScale / 2.0 - kMainPageDistance, GYHScreenHeight / 2)  //打开左侧窗时，中视图中心点

#define vCouldChangeDeckStateDistance  (GYHScreenWidth - kMainPageDistance) / 2.0 - 40 //滑动距离大于此数时，状态改变（关--》开，或者开--》关）
